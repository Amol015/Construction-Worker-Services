    ...
    <Container style={{ backgroundColor: "white" }}>
      ...
      <Row>
        ...
        <Col>
          ...
          <br />
          <b>
            Switch Replacement (wall decor)<br></br>
          </b>
          <b>
            Rs 109 <br /> Time: 10 Mins
          </b>
          <br />
          ...
          <br />
          Replacement of single Switch
          <br />
          Spare parts cost not included.
          <a href="todo">View Details</a>
          <hr />
          <b>
            Socket Replacement <br></br>
          </b>
          <b>
            Rs 109 <br /> Time: 10 Mins
          </b>
